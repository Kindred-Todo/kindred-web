...
export function MotivationSection() {
  ...
  return (
    <section className="relative w-full bg-white overflow-hidden" style={{ padding: isMobile ? '64px 0' : `${scale(96)} 0` }}>
      <div style={{ padding: isMobile ? '0 16px' : `0 ${scale(126)}` }}>
        <div style={{ maxWidth: isMobile ? '100%' : scale(934) }}>
          <p className="font-outfit font-normal capitalize leading-[1.25] text-black tracking-[-0.48px]" style={{ fontSize: isMobile ? '28px' : scale(48) }}>
            You've tried every productivity app.
          </p>
          <p className="font-outfit font-normal capitalize leading-[1.25] tracking-[-0.48px]" style={{ fontSize: isMobile ? '28px' : scale(48) }}>
        ...
        <div className="bg-primary" style={{ height: '3px', width: isMobile ? '150px' : scale(200), marginTop: isMobile ? '24px' : scale(24) }} />
        <p className="font-outfit font-normal capitalize leading-[1.25] text-black tracking-[-0.18px] md:ml-auto" style={{ fontSize: isMobile ? '16px' : scale(18), maxWidth: isMobile ? '100%' : scale(355), marginTop: isMobile ? '16px' : scale(-100), marginLeft: isMobile ? '0' : 'auto' }}>
          Because doing it alone was never actually the plan. The best version of you is built with the people around you.
        </p>
      </div>
      <div style={{ marginTop: isMobile ? '40px' : scale(64) }}>
